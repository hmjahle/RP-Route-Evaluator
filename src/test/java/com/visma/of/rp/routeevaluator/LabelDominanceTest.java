...
public class LabelDominanceTest {
    ...
    public void resourceAndObjectiveValue() {
        ...
        Label labelA = new Label(null, null, null, null, null, costA, 3, resourcesA, 0, 2);
        Label labelB = new Label(null, null, null, null, null, costB, 3, resourcesA, 0, 2);
        Label labelC = new Label(null, null, null, null, null, costA, 3, resourcesB, 0, 2);
        Label labelD = new Label(null, null, null, null, null, costB, 3, resourcesB, 0, 2);
    ...
    public void currentTimeAndDrivingTime() {
        ...
        Label labelA = new Label(null, null, null, null, null, costA, 1, resources, 0, 2);
        Label labelB = new Label(null, null, null, null, null, costA, 2, resources, 0, 1);

        Label labelC = new Label(null, null, null, null, null, costA, 3, resources, 0, 3);
        Label labelD = new Label(null, null, null, null, null, costA, 4, resources, 0, 4);
    ...
    public void currentTimeAndDrivingTimeAndObjectiveValue() {
        ...
        Label labelA = new Label(null, null, null, null, null, costA, 1, resources, 0, 1);
        Label labelB = new Label(null, null, null, null, null, costA, 2, resources, 0, 2);

        Label labelC = new Label(null, null, null, null, null, costB, 1, resources, 0, 1);
        Label labelD = new Label(null, null, null, null, null, costB, 2, resources, 0, 2);
    ...
    public void currentTimeAndDrivingTimeAndObjectiveValueAndResources() {
        ...
        Label labelA = new Label(null, null, null, null, null, costA, 1, resourcesA, 0, 1);
        Label labelB = new Label(null, null, null, null, null, costA, 2, resourcesA, 0, 2);

        Label labelC = new Label(null, null, null, null, null, costB, 1, resourcesB, 0, 1);
        Label labelD = new Label(null, null, null, null, null, costB, 2, resourcesB, 0, 2);
    ...
    public void objectiveValueAndResources() {
        ...
        Label labelA = new Label(null, null, null, null, null, costA, 1, resourcesA, 0, 0);
        Label labelB = new Label(null, null, null, null, null, costB, 1, resourcesA, 0, 0);

        Label labelC = new Label(null, null, null, null, null, costA, 1, resourcesB, 0, 0);
        Label labelD = new Label(null, null, null, null, null, costB, 1, resourcesB, 0, 0);
    ...
    public int labelTest(Label a, Label b) {
        Label labelA = new Label(null, a.getPrevious(), a.getNode(), a.getPhysicalLocation(), a.getEdge(), a.getObjective(), a.getCurrentTime(), a.getResources(), 0, a.getCanLeaveLocationAtTime());
        Label labelB = new Label(null, b.getPrevious(), b.getNode(), b.getPhysicalLocation(), b.getEdge(), b.getObjective(), b.getCurrentTime(), b.getResources(), 0, b.getCanLeaveLocationAtTime());
