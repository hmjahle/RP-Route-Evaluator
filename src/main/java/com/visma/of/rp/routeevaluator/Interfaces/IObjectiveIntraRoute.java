...
public interface IObjectiveIntraRoute {
     ...
     *
     * @param incrementalObjectiveInfo Holds information regarding the current state of the
     *                                 route used to calculate the objective value.
     * @return The change in objective value for this part of the route.
     */
    double calculateIncrementalObjectiveValueFor(IncrementalObjectiveInfo incrementalObjectiveInfo);
}
